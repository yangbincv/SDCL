...
class build_transformer(nn.Module):
    def __init__(self, num_classes, camera_num, view_num, cfg, factory):
        ...
        self.bottlenecks = nn.BatchNorm1d(768)
        self.bottlenecks.bias.requires_grad_(False)
        self.bottlenecks.apply(weights_init_kaiming)

        self.dropout = nn.Dropout(self.dropout_rate)
        # model_path = osp.join('/data1/yb_log/adca_vit_sdof_logs/sysu_2p_288_g_s122_sdofv3hm0ht10rgbir_sn05_sd1_05_cmjacos_noca09_ht09hmt09_a100_smotop10', 'model_best.pth.tar')
        # if pretrain_choice == 'self':
    ...
    # def forward(self, x1, x2, modal=0,label_1=None,label_2=None):#(self, x, label=None, cam_label= None, view_label=None):
        ...
        features,feat1,feat2,x_s,label_1,label_2,index_1,index_2 = self.base(x1,x2,modal=modal,label_1=label_1,label_2=label_2,index_1=index_rgb,index_2=index_ir)
        # global branch
        ...
        x_s = self.b2(torch.cat((token, x_s), dim=1))
        features_s = x_s[:, 0]
        x_s = self.bottlenecks(features_s)
        feat = clsfeat
        if self.training:
            return feat,feat[:single_size_1],feat[single_size_1:],x_s[:single_size_1],x_s[single_size_1:],label_1,label_2,cid_rgb,cid_ir,index_1,index_2
        else:
            return feat,x_s
